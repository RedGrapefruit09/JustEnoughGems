...
object JEGOres : IInitializer {
    ...
    val RUBY_ORE_OVERWORLD = createOreConfig(RUBY_ORE, 5, 12, 5)
    val AQUAMARINE_ORE_OVERWORLD = createOreConfig(AQUAMARINE_ORE, 4, 12, 0)
    val TANZANITE_ORE_OVERWORLD = createOreConfig(TANZANITE_ORE, 4, 12, 0)
    val TSAVORITE_ORE_OVERWORLD = createOreConfig(TSAVORITE_ORE, 4, 12, 0)
    val VERDELITE_ORE_OVERWORLD = createOreConfig(VERDELITE_ORE, 4, 12, 0)
    val INDIGOLITE_ORE_OVERWORLD = createOreConfig(INDIGOLITE_ORE, 4, 12, 0)
    val OPAL_ORE_OVERWORLD = createOreConfig(OPAL_ORE, 4, 12, 0)
