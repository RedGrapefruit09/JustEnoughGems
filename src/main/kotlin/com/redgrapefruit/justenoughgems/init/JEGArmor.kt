...
object JEGArmor : IInitializer {
    ...
    // Tsavorite
    val TSAVORITE_BOOTS = GemBootsItem(JEGArmorMaterials.TSAVORITE, GemArmorConfig.TSAVORITE, 13)
    val TSAVORITE_LEGGINGS = GemLeggingsItem(JEGArmorMaterials.TSAVORITE, GemArmorConfig.TSAVORITE, 13)
    val TSAVORITE_CHESTPLATE = GemChestplateItem(JEGArmorMaterials.TSAVORITE, GemArmorConfig.TSAVORITE, 13)
    val TSAVORITE_HELMET = GemHelmetItem(JEGArmorMaterials.TSAVORITE, GemArmorConfig.TSAVORITE, 13)

    // Verdelite
    val VERDELITE_BOOTS = GemBootsItem(JEGArmorMaterials.VERDELITE, GemArmorConfig.VERDELITE, 14)
    val VERDELITE_LEGGINGS = GemLeggingsItem(JEGArmorMaterials.VERDELITE, GemArmorConfig.VERDELITE, 14)
    ...
    // Opal
    val OPAL_BOOTS = GemBootsItem(JEGArmorMaterials.OPAL, GemArmorConfig.OPAL, 16)
    val OPAL_LEGGINGS = GemLeggingsItem(JEGArmorMaterials.OPAL, GemArmorConfig.OPAL, 16)
    val OPAL_CHESTPLATE = GemChestplateItem(JEGArmorMaterials.OPAL, GemArmorConfig.OPAL, 16)
    val OPAL_HELMET = GemHelmetItem(JEGArmorMaterials.OPAL, GemArmorConfig.OPAL, 16)
    ...
    override fun initialize() {
        ...
        register("tsavorite_boots", TSAVORITE_BOOTS)
        register("tsavorite_leggings", TSAVORITE_LEGGINGS)
        register("tsavorite_chestplate", TSAVORITE_CHESTPLATE)
        register("tsavorite_helmet", TSAVORITE_HELMET)

        register("verdelite_boots", VERDELITE_BOOTS)
        ...
        register("opal_boots", OPAL_BOOTS)
        register("opal_leggings", OPAL_LEGGINGS)
        register("opal_chestplate", OPAL_CHESTPLATE)
        register("opal_helmet", OPAL_HELMET)
    }
}
