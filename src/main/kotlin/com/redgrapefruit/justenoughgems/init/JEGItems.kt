...
object JEGItems : IInitializer {
    ...
    // Shields
    val QUARTZ_SHIELD = GemShieldItem(1, 50, 2500, 95, 16, QUARTZ_INGOT)
    val ANDALUSITE_SHIELD = GemShieldItem(2, 60, 2750, 90, 17, ANDALUSITE_INGOT)
    val MORGANITE_SHIELD = GemShieldItem(3, 70, 3000, 85, 18, MORGANITE_INGOT)
    val TAAFFEITE_SHIELD = GemShieldItem(4, 80, 3250, 80, 19, TAAFFEITE_INGOT)
    val PINK_QUARTZ_SHIELD = GemShieldItem(5, 90, 3500, 75, 20, PINK_QUARTZ_INGOT)
    val EUCLASE_SHIELD = GemShieldItem(6, 100, 3750, 70, 21, EUCLASE_INGOT)
    val CHRYSOLITE_SHIELD = GemShieldItem(7, 110, 4000, 65, 22, CHRYSOLITE_INGOT)
    val SAPPHIRE_SHIELD = GemShieldItem(8, 120, 4250, 60, 23, SAPPHIRE_INGOT)
    val HELIODORE_SHIELD = GemShieldItem(9, 130, 4500, 55, 24, HELIODORE_INGOT)
    val RUBY_SHIELD = GemShieldItem(10, 140, 4750, 50, 25, RUBY_INGOT)
    val AQUAMARINE_SHIELD = GemShieldItem(11, 150, 5000, 45, 26, AQUAMARINE_INGOT)
    val TANZANITE_SHIELD = GemShieldItem(12, 160, 5250, 40, 27, TANZANITE_INGOT)
    val TSAVORITE_SHIELD = GemShieldItem(13, 170, 5500, 35, 28, TSAVORITE_INGOT)
    val VERDELITE_SHIELD = GemShieldItem(14, 180, 5750, 30, 29, VERDELITE_INGOT)
    val INDIGOLITE_SHIELD = GemShieldItem(15, 190, 6000, 25, 30, INDIGOLITE_INGOT)
    val OPAL_SHIELD = GemShieldItem(16, 200, 6250, 20, 31, OPAL_INGOT)
